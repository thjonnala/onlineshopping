...
const styles = {
  ...
  title: { fontSize: 28, fontWeight: 800, color: '#212121', margin: '0 0 12px' },
  ...
  orderId: { fontSize: 24, fontWeight: 800, color: '#1a73e8', margin: 0 },
  ...
  primaryBtn: { background: '#1a73e8', color: '#fff', padding: '12px 28px', borderRadius: 4, textDecoration: 'none', fontWeight: 700, fontSize: 15 },
  secondaryBtn: { background: 'transparent', color: '#1a73e8', border: '2px solid #1a73e8', padding: '12px 28px', borderRadius: 4, textDecoration: 'none', fontWeight: 700, fontSize: 15 },
};
