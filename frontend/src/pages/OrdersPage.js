...
const STATUS_COLOR = { Pending: '#f5a623', Confirmed: '#3182ce', Processing: '#805ad5', Shipped: '#dd6b20', Delivered: '#38a169', Cancelled: '#e53e3e' };
...
const styles = {
  ...
  shopBtn: { display: 'inline-block', marginTop: 16, background: '#f5a623', color: '#1a1a2e', padding: '12px 28px', borderRadius: 6, textDecoration: 'none', fontWeight: 700 },
  page: { background: '#f7f7f7', minHeight: '100vh', padding: '24px 16px' },
  container: { maxWidth: 860, margin: '0 auto' },
  title: { fontSize: 26, fontWeight: 700, color: '#1a1a2e', marginBottom: 24 },
  ...
  orderId: { fontSize: 16, fontWeight: 700, color: '#1a1a2e', margin: 0 },
  ...
  orderTotal: { fontSize: 18, fontWeight: 700, color: '#1a1a2e', margin: '6px 0 0' },
  ...
  itemName: { fontSize: 14, fontWeight: 600, color: '#1a1a2e', margin: 0 },
