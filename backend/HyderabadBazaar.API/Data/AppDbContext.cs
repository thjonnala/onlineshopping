...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    private static void SeedData(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Category>().HasData(
            ...
            new Category { Id = 6, Name = "Hyderabadi Sweets", Description = "Double ka meetha, Qubani ka meetha and traditional sweets", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Kheer_Indian_Sweet_Dessert_Mithai_2010.jpg/500px-Kheer_Indian_Sweet_Dessert_Mithai_2010.jpg", IsActive = true }
        );
        ...
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product { Id = 18, Name = "Double Ka Meetha Mix", Description = "Ready-to-make mix for Hyderabad's beloved bread pudding dessert — Double Ka Meetha.", Price = 199, DiscountPrice = 169, Stock = 180, CategoryId = 6, Rating = 4.5, ReviewCount = 723, ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Shahi_Tukra.jpg/500px-Shahi_Tukra.jpg", IsActive = true, CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
